...
file_name_omega=dir_name + "\\omega_GW_" + str(num) + ".txt"
...
file_name_f_m= dir_name + "\\f_m_" + str(num) + ".txt"
...
plt.legend()
plt.savefig(dir_name+"\\funzione_logaritmica_di_massa")
...
plt.savefig(dir_name+"\\prodotto_di_convoluzione_f_m")
