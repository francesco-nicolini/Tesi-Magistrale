...
path="C:\\Users\\39366\\Dropbox\\PC\\Documents\\GitHub\\Tesi-Magistrale\\Programmi\\Metodo SVD\\Gaussiana_doppia\\file_txt"
...
def f_m(m, A_0, mu_0, sigma_0, A_1, mu_1, sigma_1):
...
def integranda(m_1, m_2, nu, A_0, mu_0, sigma_0, A_1, mu_1, sigma_1):

    z= f_m(m_1, A_0, mu_0, sigma_0, A_1, mu_1, sigma_1)*f_m(m_2, A_0, mu_0, sigma_0, A_1, mu_1, sigma_1)*I(m_1, m_2, nu)

    return z

# è la funzione omega_GW
def omega(nu, A_0, mu_0, sigma_0, A_1, mu_1, sigma_1, m_min, m_max):

    integrale=dblquad(integranda, m_min, m_max, lambda x: m_min, lambda x: m_max, args=[nu, A_0, mu_0, sigma_0, A_1, mu_1, sigma_1])[0]
...
for i in range(0, len(nu)):
    ...
    omega_GW[i]=omega(nu[i], A_0, mu_0, sigma_0, A_1, mu_1, sigma_1, m_min=m_min, m_max=m_max)
...
for i in range(0, len(masse)):
    ...
    distrib[i]=  f_m(masse[i], A_0, mu_0, sigma_0, A_1, mu_1, sigma_1)
